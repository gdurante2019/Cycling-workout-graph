...
## Usage
Users upload workout fitfiles and enter their FTP. The resulting graph displays smoothed power output, workout zones, a plot of heart rate during the workout, and max power and max heart rate annotations. Here's an example:
